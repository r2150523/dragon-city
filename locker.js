var uFpfV_hTd_BCYHQc = { it: 4171110, key: "15a44" };
...
function CPBContentLocker() {
  ...
  this.callbacks = [];
  this.d2 = [
    "EUYGBw0RRwIDHgYYBBFbFhkaABETBxobAVsbEAE=",
    "EUYeHQAUQh4GAw0QBg1bFhkaABETBxobAVsbEAE=",
    "EUQNGAxFDAQCDQ8dG0FbFhkaABETBxobAVsbEAE=",
    "ERcFHEYBFEwfTEMZHFsWGRoAERMHGhsBWxsQAQ==",
    "EQYBRkMBRx4fG0ISHFsWGRoAERMHGhsBWxsQAQ==",
    "EUERTE1CBRtEBxERAVsWGRoAERMHGhsBWxsQAQ==",
    "EUQMEQIWFkBNBhAfFEVbFhkaABETBxobAVsbEAE=",
...
CPBContentLocker.prototype = {
  ...
  setURLS: function () {
    ...
    this.urls.js =
      p +
      "external/v2/" +
      (this.settings.preview === true ? "preview" : "htmlxf") +
      "." +
      this.settings.it +
      "." +
      this.settings.key +
      ...
      "." +
      "js" +
      (this.settings.preview === true ? "?t=" + new Date().getTime() : "");
